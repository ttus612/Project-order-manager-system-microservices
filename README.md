...
```
cd existing_repo
git remote add origin https://gitlab.com/group09-kttkpm-doan/order-manager-system.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/group09-kttkpm-doan/order-manager-system/-/settings/integrations)
